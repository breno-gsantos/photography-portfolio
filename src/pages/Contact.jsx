      ...
      <div className='container mx-auto h-full'>
        ...
        <div className='flex flex-col lg:flex-row h-full items-center justify-start pt-36 gap-x-8 text-center lg:text-left'>
          ...
          <div className='lg:flex-1 lg:pt-20 px-4'>
            ...
            <p className='mb-12'>I'd love to get suggestions from you.</p>
            <form className='flex flex-col gap-y-4'>
              <div className='flex gap-x-10'>
                ...
                <input type='text' placeholder='Your E-mail address' className='outline-none border-b border-b-primary h-[60px] bg-transparent font-secondary w-full pl-3 placeholder:text-[#757879]' />
              </div>
          ...
          <motion.div initial={{opacity: 0, y: '100%'}} animate={{opacity: 1, y: 0}} exit={{opacity: 0, y: '100%'}} transition={{transition: transition1, duration: 1.5}} className='lg:flex-1'>
            <img src={WomanImg} alt='womanImage' className='w-[400px] h-auto' />
          </motion.div>
        </div>
